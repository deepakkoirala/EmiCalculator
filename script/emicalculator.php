...
?>
	<tr>
		...
		echo date("M j, Y",mktime(0,0,0,$arrDate1[1],$arrDate1[2],$arrDate1[0]));
		 ?></td>
		<td>Rs. <?php echo number_format(round($r)); ?>.00</td>
		<td>Rs. <?php  echo number_format($t); ?>.00</td>
		<td>Rs. <?php echo number_format($p);  ?>.00</td>
		<td>Rs. <?php echo number_format($monthly); ?>.00</td>
		<td>Rs. <?php echo number_format(round($e));  ?>.00</td>
	</tr>
<?php
	return getEmi($e);
}
...
<form name="loandata" method="post" action="">
  <table id="emi" width="100%">
    ...
    <tr>
      <td>&nbsp;</td>
      <td width="48%">Amount of the loan (any currency):<span class="err">*</span></td>
      <td><input type="text" name="principal" size="12" ></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Annual percentage rate of interest: <span class="err">*</span></td>
      <td><input type="text" name="interest" size="12"></td>
    </tr>

    <tr>
      <td>&nbsp;</td>
      <td>Repayment period in years: <span class="err">*</span></td>
      <td><input type="text" name="years" size="12"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Start Date of Loan:</td>
      <td><input type="text" name="start_date" size="12" id="start_date"></td>
    </tr>
    <tr><td colspan="3">
...
<tr>
	<td colspan="7">
		...
		<tr>
		  ...
		  <td><span id="monthly">Rs.<?php echo round($monthly); ?>.00</span></td>
		</tr>
		<tr>
		  <td>&nbsp;</td>
...
<?php if(!empty($error)) : ?>
<tr>
<td colspan="6" style="color:#F00; font-size:18px;"><?php echo $error; ?></td>
</tr>
<?php endif; ?>
</table>
